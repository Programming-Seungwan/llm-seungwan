...
def scrape_linkedin_profile(linkedin_profile: str, mock: bool = False):
  """
  scrape information from LinkedIn profiles, Manually scrape the information from the LinkedIn profiles
  """
  ...
  data = response.json() # 파이썬 프로그래밍 언어에서는 변수가 블록 단위가 아니라 파일, 모듈 단위로 동작한다.
...
if __name__ == "__main__":
  print(
    scrape_linkedin_profile(linkedin_profile="https://www.linkedin.com/in/eden-marco")
  )